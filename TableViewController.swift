...
//    static var arrayStudents = [ Student(name: "Александр", surname: "Иванов", age: "21", info: "-", gender: .male), Student(name: "Николай", surname: "Зайцев", age: "27", info: "-", gender: .preferNotToSay), Student(name: "Анатолий", surname: "Петров", age: "32", info: "-", gender: .male), Student(name: "Вероника", surname: "Дынная", age: "43", info: "-", gender: .female), Student(name: "Петр", surname: "Плюшкин", age: "48", info: "-", gender: .male), Student(name: "Евгений", surname: "Кондратюк", age: "29", info: "-", gender: .male), Student(name: "Максим", surname: "Киркоров", age: "31", info: "-", gender: .male), Student(name: "Борис", surname: "Басков", age: "54", info: "-", gender: .male), Student(name: "Филипп", surname: "Зуев", age: "25", info: "-", gender: .male), Student(name: "Раиса", surname: "Мартынина", age: "20", info: "-", gender: .female), Student(name: "Иван", surname: "Пупкин", age: "26", info: "-", gender: .male), Student(name: "Егор", surname: "Малышев", age: "-", info: "27", gender: .preferNotToSay), Student(name: "Анастасия", surname: "Мандаринова", age: "27", info: "-", gender: .female), Student(name: "Елена", surname: "Апельсинова", age: "32", info: "-", gender: .female), Student(name: "Людмила", surname: "Ананасова", age: "22", info: "-", gender: .female), Student(name: "Ксения", surname: "Арбузова", age: "", info: "-", gender: .female),  Student(name: "Аполлинария", surname: "Огурцова", age: "31", info: "-", gender: .female), Student(name: "Зинаида", surname: "Карапузова", age: "42", info: "-", gender: .female), Student(name: "Татьяна", surname: "Лимонная", age: "12", info: "-", gender: .female), Student(name: "Ирина", surname: "Колбасная", age: "18", info: "-", gender: .female) ]
...
//    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return TableViewController.arrayStudents.count
    }
    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        var cell: UITableViewCell
        let student = TableViewController.arrayStudents[indexPath.row]
        ...
        switch student.gender {
            ...
            case .female:
                ...
                break
            case.preferNotToSay:
                cell = tableView.dequeueReusableCell(withIdentifier: "yellow", for: indexPath)
                break
        }
